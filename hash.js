...
/* ---- একেবারে প্রথম চালানের PIH ----
   ...
   ZATCA-র নিজের নথিতে এই মানটা লেখা নেই — খুঁজে দেখা হয়েছে, নেই। তবে
   বাইরের একটা স্বাধীন বাস্তবায়নেও (MIT লাইসেন্সের PHP লাইব্রেরি) হুবহু
   এই মানটাই ব্যবহার হয়েছে। দুই দিক থেকে একই জায়গায় পৌঁছানো ভরসা দেয়,
   কিন্তু সরকারি নিশ্চয়তা নয় — ❓ SDK দিয়ে মিলিয়ে নেওয়া দরকার। */
function firstPih() {
