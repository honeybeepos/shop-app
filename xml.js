/* ============================================================
   ...
   ⚠️ যেটা এখনো প্রমাণ হয়নি: এই XML ZATCA-র স্কিমা ও ব্যবসায়িক নিয়ম
   (schema + schematron) মানে কিনা। সেটা ZATCA-র নিজের SDK ছাড়া যাচাই
   করা যায় না। নিচের কয়েকটা ধ্রুবক (ProfileID ইত্যাদি) SDK দিয়ে একবার
   মিলিয়ে নেওয়া দরকার — আলাদা করে চিহ্নিত করা আছে।
   ============================================================ */
"use strict";

/* ---- যে ধ্রুবকগুলো SDK দিয়ে মিলিয়ে নিতে হবে ----
   নথিতে জায়গাভেদে একাধিক মান দেখা যায়, তাই এগুলো এক জায়গায় রাখা হলো —
   SDK যাচাইয়ের পর দরকার হলে শুধু এখানেই বদলাতে হবে, কোডের ভেতরে খুঁজতে
   হবে না। */
const ZATCA_CONST = {
  profileId: "reporting:1.0",          // ❓ SDK দিয়ে মেলাতে হবে
